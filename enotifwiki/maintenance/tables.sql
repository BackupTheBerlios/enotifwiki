...
CREATE TABLE /*$wgDBprefix*/user (
  ...
  user_enotif_newpages tinyint(1) NOT NULL default '0',
...
CREATE TABLE /*$wgDBprefix*/watchlist (
 ...
 -- Allows direct links to difference views between
 -- current and last-seen revisions of watched pages
 -- records rc_last_oldid of the last revision the user saw
  wl_lastvisitedrevision int(10) unsigned NOT NULL default '0',
