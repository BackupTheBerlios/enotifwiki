...
/*	'EnotifNewPages' is not a DefaultUserOption and
	therefore not listed here.

	The default value of is false and stems from
	global switch values $wgEmailNotificationForNewPages
	and $wgEmailNotificationForNewPagesAllowedForAll
	and user rights sysop, developer, bureaucrat.

	These together determines, whether the option is shown for
	a certain user, which then allows to opt-in.
*/
...
'tog-hover'	=> 'Show tooltips over wiki links',
...
'tog-rccurrevonly' 		=> 'Show only the current revision of pages in recent changes view.',
...
'newmsg' => 'You have new messages on your $1.',
'newmsg_user' => 'user page',
'newmsg_usertalk' => 'discussion page',
'newmsg_and' => 'and',
'editsection'=>'edit',
'toc' => 'Contents',
'showtoc' => 'show',
...
{{SERVER}}{{localurl:Special:Userlogin|wpName=$4&wpPassword=$3&returnto=Special:Preferences}}",
...
'emailauthenticated'        => 'Your email address $1 was authenticated on $2.',
'emailnotauthenticated'     => 'Your email address is <strong>not yet authenticated</strong>. No email
will be sent for any of the following features.',
'disableduntilconfirmation'	=> '<strong>(disabled)</strong>',
...
'cur'			=> 'cur',
'cur_tooltiptext'	=> 'Show difference between this and current version of',
'next'			=> 'next',
'last'			=> 'last',
'last_tooltiptext'	=> 'Show difference between this and preceding version of',
'orig'			=> 'orig',
...
'enotifnewpages'	=> 'Send me an email when a new page is created',
...
'diff'			=> 'diff',
'diff_tooltiptext'	=> 'Show difference between this revision and the previous revision of',
'diff-to-lvr'		=> 'last seen',
'diff-to-lvr_tooltiptext' => 'Show difference between this revision and the last visited revision of',
'lvr'			=> '<span class=\'updatedmarker\'>last seen</span>',
'lvr_tooltiptext'  	=> 'This is the last visited revision of',
'hist'			=> 'hist',
'hist_tooltiptext'	=> 'Show history of',
'hide'			=> 'Hide',
'show'			=> 'show',
'tableform'		=> 'table',
'listform'		=> 'list',
