...
$wgVersion			= '1.5beta4 (CVS 200508131900) special version EnotifWiki v3.48 + FCKeditor 2.0 FC';
...
$wgEmailAuthentication			= true;  # UPO (if this is set to false, texts referring to e-mail address confirmation are suppressed)
$wgEmailAuthenticationRequiredForAll	= false; # false means: Sysops, Bureaucrats and Developers don't need to confirm their email addresses
$wgEnotifWatchlist			= true; # UPO
$wgEnotifUserTalk			= true; # UPO
$wgEnotifRevealEditorAddress		= true;  # UPO; reply-to address may be filled with page editor's address (if user opted-in)
$wgEnotifMinorEdits			= true;	# UPO; false: "minor edits" on pages do not trigger notification mails.
#						# Attention: _every_ change on a user_talk page trigger a notification mail (if the user is not yet notified)
$wgEnotifForAnyChange			= false; # usually set to false: only one Enotif is sent out on the first unseen change
$wgEnotifNewPages			= true;  # show the option
$wgEnotifNewPagesAllowedForAll		= true;  # false means: only Sysops, Bureaucrats and Developers see this option
...
# This will be set to false with AutoLogin,
# as this uses real name field for storing userid of logged-in user
...
/* see bugzilla 1360 (Auto-Login / Auto-Account creation) */
$wgAutoLogin = false;
/*
 * The patch uses the field "user_realname" for storing the userid or hostname
 * as detected by the authentication software, therefore it must be disabled now
 */
if ($wgAutoLogin) $wgAllowRealName=false;
