...
#------------------------------------------------------------------------------
	...
	function wl_notificationtimestampIsNULL() {
		return 'wl_notificationtimestamp = 0'; 		# for VARCHAR(14)

		## depending on your table definition it can also be
		## return 'wl_notificationtimestamp IS NULL'; 	# for DATETIME

		## underlying problem:
		##
		## MySQL queries need different syntax when testing against NULL value
	...
	function timestampOrNull( $ts = null ) {
		if( is_null( $ts ) || ($ts == 0) ) {
			return 0;
			## depending on your table definition it can be
			## return null;
		} else {
